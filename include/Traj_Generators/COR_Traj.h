...
public:
  ...
  /*
      Constructor
  */
  COR_Traj(const TooN::Vector<3> &COR, const TooN::Vector<3> &normal,
           const TooN::Vector<3> &pi, const UnitQuaternion &initial_quat,
           const Scalar_Traj_Interface &traj_theta);

  COR_Traj(const UnitQuaternion &initial_quat,
