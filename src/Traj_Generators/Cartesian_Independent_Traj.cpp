...
/*
    Constructor
*/
Cartesian_Independent_Traj::Cartesian_Independent_Traj( const Position_Traj_Interface& pos_traj, const Quaternion_Traj_Interface& quat_traj )
    :Cartesian_Traj_Interface( NAN, NAN ),
    _pos_traj(pos_traj.clone()),
...
Cartesian_Independent_Traj::Cartesian_Independent_Traj( const Cartesian_Independent_Traj& traj )
    :Cartesian_Traj_Interface( NAN, NAN ),
    _pos_traj(traj._pos_traj->clone()),
